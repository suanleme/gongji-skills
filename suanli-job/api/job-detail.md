...
paths:
  /api/task/job/detail:
    get:
                      ...
                      job_support:
                        ...
                        properties:
                          estimated_exec_sec:
                            ...
                            title: 单元运行时间(秒)
                            description: >-
                              任务运行完成的预估时间，系统将基于此时间寻找最稳定的资源窗口。该字段仅在 Job 批处理任务的
                              sub_type 为 Spot 时生效且必填；其他 sub_type
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3025695/apis/api-445572420-run
components:
  schemas:
    IResponse:
      type: object
