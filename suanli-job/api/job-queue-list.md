...
info:
  ...
  version: 1.0.0
paths:
  /api/job/queue/group/search:
    get:
      summary: Job任务队列任务组列表查询接口
      deprecated: false
      description: >-
      ...
      parameters:
        ...
        - name: status
          in: query
          description: 组状态。如果有多个值，请使用英文逗号（,）分隔
          required: false
        ...
        - name: page_size
          in: query
          description: 每页数量，备注：page_size范围1~50
          required: false
          example: 默认:10
          schema:
            type: integer
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3025695/apis/api-481938991-run
components:
  schemas:
    GroupDto:
      type: object
