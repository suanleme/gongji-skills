  ...
  /api/storage/nas/v1/expand:
    post:
      ...
      description: >-
        ...
        扩容集群存储卷。仅 Active 状态的卷可扩容，目标容量必须大于当前容量。受理成功后 status 为 Expanding。
      ...
      requestBody:
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/NasExpandReq'
            example:
              id: 1001
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3025695/apis/api-502709060-run
components:
  schemas:
    NasExpandReq:
      type: object
