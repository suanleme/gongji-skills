  ...
  /api/storage/nas/v1/s3/delete:
    post:
      ...
      description: >-
        ...
        删除对象存储互传任务。已删除的任务再次调用仍返回成功。成功后 status 为 Deleted。
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3025695/apis/api-502709067-run
components:
  schemas:
    S3IdReq:
      type: object
