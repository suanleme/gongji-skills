  ...
  /api/deployment/task/update:
    post:
      ...
      description: >+
        ...
        因此，调用接口时，请求数据结构必须与
        [任务详情查询接口](https://s.apifox.cn/6aa360d3-d8f2-471e-b841-3a35c33a7b7c/api-296882076.md)
        响应中的任务配置在结构上保持**完全一致**。
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/3025695/apis/api-269530619-run
components:
  schemas:
    IHealthCheck:
      type: object
